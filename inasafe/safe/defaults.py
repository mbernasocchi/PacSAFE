...
def disclaimer():
    ...
    :rtype: str
    """
    text = tr('PacSAFE has been developed from InaSAFE by the Secretariat of the Pacific Community in collaboration with the National Institute of Water & Atmospheric Research Ltd, with support from the Asian Development Bank. InaSAFE has been jointly developed by Indonesian Government-BNPB, Australian Government-AIFDR and the World Bank-GFDRR.These agencies and the individual software developers of InaSAFE and PacSAFE take no responsibility for the correctness of outputs from InaSAFE of PacSAFE or decisions derived as a consequence.')
    return text
...
def limitations():
    ...
    limitation_list.append(tr('PacSafe and InaSAFE are not a hazard modelling tool.'))
    ...
    limitation_list.append(
        tr('PacSafe and InaSAFE is a Free and Open Source Software (FOSS) project, '
